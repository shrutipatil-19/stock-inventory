            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
                    ...
                    <div class="row g-0 p-1">
                        ...
                        <div class="col-3 text-center">
                            <a href="" class="dropdown-item d-flex flex-column align-items-center justify-content-center w-70px h-70px"><i data-feather="calendar" class="icon-lg mb-1"></i>
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        ...
                        <div class="text-center">
                            ...
                            <p class="fs-16px fw-bolder">shruti</p>
                            <p class="fs-12px text-secondary">shruti@gmail.com</p>
                        </div>
                    </div>
